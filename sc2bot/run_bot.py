...
# SC2 Bot Dependencies
from sc2.bot_ai import BotAI                # inherited from BurnySC2's BotAI
from sc2.data import Difficulty, Race       # bot difficulty and the 1 of 3 races
...
result = run_game(
    ...
    [
        # Pass bot handler.
        Bot(BOT_RACE, WorkerBot()),
        # Setting constants computer bot will play against.
        Computer(ENEMY_RACE, ENEMY_DIFFICULTY)
    ],
    # When set to True, the agent is limited in how long 
    # each step can take to process.
    realtime=False,
)
